          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <a href="http://www.cqut.edu.cn/" title="资源下载" target="_blank">资源下载</a>|
                <span>服务热线：13489006071(福建)</span>
                <span>Email：1731976958@qq.com</span>
              </section>
  ...
  export default {
    ...
    methods: {
      ...
      logout(){
        ...
        cookie.set('ATAI_BigData_token', "", {domain: 'localhost'})
        //回首页
