      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-tag">
            ...
            <el-button  size="mini" type="primary" v-for="t in article.tags" :key="t.id" round plain>{{t}}</el-button>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getArticle() {
        let that = this
        blogApi.viewArticle(that.$route.params.id).then(response => {
          // debugger
      ...
      publishComment() {
        ...
        if (token) {  
            ...
            commentApi.publishComment(that.comment).then(response => {
              debugger
      ...
      getCommentsByArticle() {
        // debugger
        let that = this
        commentApi.getCommentsByArticle(1,2,that.article.id).then(response => {
          // debugger
